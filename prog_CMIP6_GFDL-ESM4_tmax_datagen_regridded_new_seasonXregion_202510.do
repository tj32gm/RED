 ...
 ** number of outliers **
 ...
 save tasmax_day_`md'_all_month`m'_regridded_clean.dta, replace
}
...
forvalues m = 1/12 {
 use  tasmax_day_`md'_all_month`m'_regridded_clean.dta, clear
 keep if year>= 1979 & year <= 2014
...
cd /media/tack/12TBHelio/CMIP6/GFDL-ESM4/
