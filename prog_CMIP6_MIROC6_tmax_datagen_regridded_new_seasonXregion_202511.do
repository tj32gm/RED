...
append using  tasmax_day_`md'_ssp585_2045_`m'_regridded.dta
append using  tasmax_day_`md'_ssp585_2075_`m'_regridded.dta
...
drop nn
 ...
 qui {
save                 tasmax_day_`md'_all_`m'_regridded.dta, replace

forvalues r = 1/`nloc' {
  use   tasmax_day_`md'_all_`m'_regridded.dta, clear
...
tabstat recordmax, s(mean sd) by(year)
